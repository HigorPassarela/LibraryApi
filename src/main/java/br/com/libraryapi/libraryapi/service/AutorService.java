...
import br.com.libraryapi.libraryapi.exceptions.OperacaoNaoPermitidaException;
...
import br.com.libraryapi.libraryapi.validator.AutorValidator;
...
public class AutorService {
    ...
    public Autor atualizar(Autor autor) {
        if (autor.getId() == null) {
            throw new IllegalArgumentException("Para atualizar, é necessario que o autor já esteja salvo!");
        }
        validator.validar(autor);
        return autorRepository.save(autor);
    }
